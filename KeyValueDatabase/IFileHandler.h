...
class IFileHandler {
public:
    virtual bool readFromFile(const std::string& filename, KeyValueDatabase<KeyType, ValueType>& db) = 0;
    virtual bool writeToFile(const std::string& filename, const KeyValueDatabase<KeyType, ValueType>& db) = 0;
